    ...
    <div class="common-footer">
        ...
        <p class="copyright">
          {{ $store.state.settings.F_Copyright }}
            <span>|</span>
          <a target="_blank" href="https://beian.miit.gov.cn/#/Integrated/index">{{ $store.state.settings.F_ICP }}</a>
            <span>|</span>
          本站总访问量：
          <i class="fa fa-eye">{{visitorCount}}</i>
...
<script type="text/ecmascript-6">
    ...
    import {listPanelGroup} from "@/api"
