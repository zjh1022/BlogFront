<template>
    <div class="about">
        <img class="background" src="./../assets/1.png" alt="">
        <img class="avatar" src="./../assets/touxiang.jpg" alt="">
        <p class="name">郑江海</p>
        <p class="desc" style="color: #555555">心念所归 无惧无退</p>
     <br/><br>
      <div class="links-of-author motion-element">
        <span class="links-of-author-item">
          <a href="https://github.com/zjh1022" title="GitHub → https://github.com/zjh1022"
        ...
        <span class="links-of-author-item">
          <a href="mailto:jianghai_1022@163.com" title="Email → mailto:jianghai_1022@163.com"
             rel="noopener" target="_blank">
